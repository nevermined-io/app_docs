...
To use the Payments libraries you need to [create a Nevermined API Key](../tutorials/integration/nvm-api-keys.mdx). This key will allow you to interact with the Nevermined platform and create Payment Plans and Agents.
