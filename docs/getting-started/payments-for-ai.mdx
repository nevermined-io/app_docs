...
AI payments are hard. Price your AI agent too low and you may be stuck with a hefty Open AI bill.
...
To register an AI, you will need your AI's web services endpoint plus JWT. The Nevermined app then
encrypts that information.

The outcome of the registration process are AI identification numbers, called DIDs, that are
...
Now AI agents have a means to monetize and to transact with external services! In other words, we've
given agents (and associated services) a payment superpowers!
