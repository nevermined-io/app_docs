...
You can find more detailed tutorials for each step [here]([url](https://docs.nevermined.app/docs/tutorials). 
...
To publish on Polygon, go directly to https://polygon.nevermined.app/ and connect your Metamask wallet to Polygon (instructions [here]([url](https://docs.nevermined.app/docs/tutorials/metamask))).

To publish on Gnosis, go directly to https://gnosis.nevermined.app/ and connect your Metamask wallet to Gnosis (instructions [here]([url](https://docs.nevermined.app/docs/tutorials/metamask))). 
...
To buy assets on Polygon, go directly to [https://polygon.nevermined.app/]([url](https://polygon.nevermined.app/)) and connect your Metamask wallet to Polygon (instructions [here]([url](https://docs.nevermined.app/docs/tutorials/metamask))).

To buy assets on Gnosis, go directly to [https://gnosis.nevermined.app/]([url](https://gnosis.nevermined.app/)) and connect your Metamask wallet to Gnosis (instructions [here]([url](https://docs.nevermined.app/docs/tutorials/metamask))).
