...
* **AI Builders** and/or AI Organizations. Who create software packaged as AI agents. AI Agents can be very different depending on their implementation. 
...
## Helping to AI Builders to focus on the AI
